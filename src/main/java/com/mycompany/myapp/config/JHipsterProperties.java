...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Laakari@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Laakari API";

        private String description = "Laakari API documentation";
